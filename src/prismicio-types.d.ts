...
/**
 * Item in *TKDSubMenu → Menu*
 */
export interface TkdsubmenuDocumentDataMenuItem {
  /**
   * Link field in *TKDSubMenu → Menu*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: tkdsubmenu.menu[].link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link: prismic.LinkField

  /**
   * Label field in *TKDSubMenu → Menu*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tkdsubmenu.menu[].label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Content for TKDSubMenu documents
 */
interface TkdsubmenuDocumentData {
  /**
   * Menu field in *TKDSubMenu*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tkdsubmenu.menu[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  menu: prismic.GroupField<Simplify<TkdsubmenuDocumentDataMenuItem>>
}

/**
 * TKDSubMenu document from Prismic
 *
 * - **API ID**: `tkdsubmenu`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/custom-types
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type TkdsubmenuDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<
  Simplify<TkdsubmenuDocumentData>,
  'tkdsubmenu',
  Lang
>

/**
 * Item in *UserMenu → Menu*
 */
export interface UsermenuDocumentDataMenuItem {
  /**
   * Link field in *UserMenu → Menu*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: usermenu.menu[].link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link: prismic.LinkField

  /**
   * Label field in *UserMenu → Menu*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: usermenu.menu[].label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  label: prismic.KeyTextField

  /**
   * SubMenu field in *UserMenu → Menu*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: usermenu.menu[].submenu
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  submenu: prismic.Repeatable<prismic.LinkField>
}

/**
 * Content for UserMenu documents
 */
interface UsermenuDocumentData {
  /**
   * Menu field in *UserMenu*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: usermenu.menu[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  menu: prismic.GroupField<Simplify<UsermenuDocumentDataMenuItem>>
}

/**
 * UserMenu document from Prismic
 *
 * - **API ID**: `usermenu`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/custom-types
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type UsermenuDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<
  Simplify<UsermenuDocumentData>,
  'usermenu',
  Lang
>
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type WatchVideoSlice = prismic.SharedSlice<'watch_video', WatchVideoSliceVariation>
...
declare module '@prismicio/client' {
  ...
  namespace Content {
    export type {
      ...
      TkdsubmenuDocument,
      TkdsubmenuDocumentData,
      TkdsubmenuDocumentDataMenuItem,
      UsermenuDocument,
      UsermenuDocumentData,
      UsermenuDocumentDataMenuItem,
      VideoDocument,
      VideoDocumentData,
