...
<Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
    ...
    <div class="effect1 container">
      ...
      <span class="text-center"><PrismicRichText field={program.data.program_title} components={{em:GoldText, heading1:Heading}}/></span>
      <div class="caption">
          <div class="leftSide"></div>
          <span class="rightInfo"><PrismicLink document={program}><button class="btn btn-md variant-filled-primary">Learn More</button></PrismicLink></span>
...
.effect1 .rightInfo {
    ...
    @apply prose prose-invert text-balance text-center;
}
