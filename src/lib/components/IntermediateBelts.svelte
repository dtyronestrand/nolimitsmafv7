...
<div class="optionsa">
    ...
    <div class={clsx("optiona", active==='orange' ? 'active':'')} on:click={()=> {if (active === 'orange'){
        active = ''} else {
            active = 'orange'
        }}
    }>
...
<div class={clsx("optiona", active==='green' ? 'active':'')} on:click={()=> {if (active === 'green'){
    active = ''} else {
        active = 'green'
    }}
}>
...
<div class={clsx("optiona", active==='purple' ? 'active':'')} on:click={()=> {if (active === 'purple'){
    active = ''} else {
        active = 'purple'
    }}
}>
...
<style>
    :root {
  --optionaColor1:orange;
  --optionaColor2:   green
  ;
  --optionaColor3: purple;
  --optionColor4: orange;
  --optionColor5: #5D9CEC;
  --optionColor6: #AC92EC;
}
...
.optiona {
  ...
  min-width: 60px;
  margin: 10px;
  background: var(--optionaBackground, var(--defaultBackground, #E6E9ED));
...
.optiona:nth-child(1) {
  --defaultBackground: var(--optionaColor1);
}

.optiona:nth-child(2) {
  --defaultBackground: var(--optionaColor2);
}

.optiona:nth-child(3) {
  --defaultBackground: var(--optionaColor3);
}

.optiona:nth-child(4) {
  --defaultBackground: var(--optionaColor4);
}
...
.optiona.active .label {
  bottom: 20px;
  left: 20px;
}

.optiona.active .label .info > div {
  left: 0;
  opacity: 1;
}
...
.optiona:not(.active) .label {
  bottom: 10px;
  left: 10px;
}

.optiona:not(.active) .label .info > div {
  left: 20px;
  opacity: 0;
}
