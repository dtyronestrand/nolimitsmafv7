...
<footer class="block w-[100%] max-h-[25vh] ">
  ...
  <span
    class="w-[100%] before:w-[100%] before:left-[120px] after:w-[100%] after:right-[120px]"
  ></span>
  <nav>
    ...
    <div class="px-[0.8rem] py-0 bg-surface-700 text-center text-yellow-500 text-lg">
      Copyright 2024 No Limits Martial Arts and Fitness - All rights resered
    </div>
  </nav>
</footer>
