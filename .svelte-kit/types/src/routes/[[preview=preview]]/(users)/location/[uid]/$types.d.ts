...
type RouteId = '/[[preview=preview]]/(users)/location/[uid]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/[[preview=preview]]/(users)/location/[uid]/+page.server.js').load>>>>>>;
