...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/[[preview=preview]]/(users)/program/[uid]/+page.server.js').load>>>>>>;
