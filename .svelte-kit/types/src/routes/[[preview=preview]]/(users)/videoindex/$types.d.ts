...
type RouteId = '/[[preview=preview]]/(users)/videoindex';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/[[preview=preview]]/(users)/videoindex/+page.server.js').load>>>>>>;
