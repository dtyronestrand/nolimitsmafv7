...
type RouteId = '/[[preview=preview]]/(users)';
...
type LayoutRouteId = RouteId | "/[[preview=preview]]/(users)/location/[uid]" | "/[[preview=preview]]/(users)/program/[uid]" | "/[[preview=preview]]/(users)/program/[uid]/belts" | "/[[preview=preview]]/(users)/program/[uid]/studenthandbook" | "/[[preview=preview]]/(users)/program/[uid]/testingapp" | "/[[preview=preview]]/(users)/program/[uid]/video/[uid]" | "/[[preview=preview]]/(users)/video/[uid]" | "/[[preview=preview]]/(users)/videoindex"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/[[preview=preview]]/(users)/+layout.server.js').load>>>>>>;
