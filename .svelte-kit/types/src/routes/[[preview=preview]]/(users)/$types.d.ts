...
type LayoutRouteId = RouteId | "/[[preview=preview]]/(users)/location/[uid]" | "/[[preview=preview]]/(users)/program/[uid]" | "/[[preview=preview]]/(users)/video/[uid]" | "/[[preview=preview]]/(users)/videoindex"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('./[uid]/+layout.server.js').load>>>>>>;
