...
type RouteId = '/[[preview=preview]]/(users)/video/[uid]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/[[preview=preview]]/(users)/video/[uid]/+page.server.js').load>>>>>>;
