...
type LayoutRouteId = RouteId | "/[[preview=preview]]" | "/[[preview=preview]]/(users)/location/[uid]" | "/[[preview=preview]]/(users)/program/[uid]" | "/[[preview=preview]]/(users)/program/[uid]/belts" | "/[[preview=preview]]/(users)/program/[uid]/studenthandbook" | "/[[preview=preview]]/(users)/program/[uid]/testingapp" | "/[[preview=preview]]/(users)/program/[uid]/video/[uid]" | "/[[preview=preview]]/(users)/video/[uid]" | "/[[preview=preview]]/(users)/videoindex" | "/[[preview=preview]]/[uid]" | "/login" | "/logout" | "/profile" | "/register" | "/slice-simulator" | "/unauthorized" | null
